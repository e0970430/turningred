...
function Transaction({ provider }: { provider: IPortkeyProvider | null }) {
    ...
    const onClick = async () => {
        try {
          ...
          const data = await transactionContract?.callSendMethod("CreateSCTransaction", account, senderID);
          console.log(data);
        } catch (error) {
        ...
        <div className="row">
            <div className="form">
                <div className="field-group">
                    ...
                    <input type="number" placeholder='' onChange={(e) => setSenderID(e.target.value)} value={senderID}/>
                </div>
                <div className="field-group">
